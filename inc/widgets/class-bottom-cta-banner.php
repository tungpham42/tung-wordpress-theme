    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .bottom-cta-banner .elementor-button' => 'border-style: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .bottom-cta-banner .elementor-button' => 'border-width: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#666666',
                'selectors' => [
                    '{{WRAPPER}} .bottom-cta-banner .elementor-button' => 'border-color: {{VALUE}};',
                ],
                'condition' => [
                    'button_border_style!' => 'none',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .bottom-cta-banner .elementor-button' => 'border-radius: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .bottom-cta-banner .elementor-button:hover' => 'border-style: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .bottom-cta-banner .elementor-button:hover' => 'border-width: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#555555',
                'selectors' => [
                    '{{WRAPPER}} .bottom-cta-banner .elementor-button:hover' => 'border-color: {{VALUE}};',
                ],
                'condition' => [
                    'button_hover_border_style!' => 'none',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .bottom-cta-banner .elementor-button:hover' => 'border-radius: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
